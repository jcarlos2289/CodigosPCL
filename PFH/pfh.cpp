...
int main (int argc, char *argv[])
{
  ...
  pcl::NormalEstimation<PointType, NormalType> norm_est2; //-----------------------------------------
...
std::cout << "Pase por aki 362" << std::endl;
