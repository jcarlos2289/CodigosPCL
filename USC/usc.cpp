...
int main (int argc, char *argv[])
{
  ...
  pcl::UniqueShapeContext<PointType, DescriptorType, RFType>  descr_est;
  descr_est.setRadiusSearch (descr_rad_);
  descr_est.setMinimalRadius(descr_rad_/10);
  descr_est.setLocalRadius(descr_rad_);
  descr_est.setPointDensityRadius(descr_rad_/5);

  descr_est.setInputCloud (model_keypoints);
  //descr_est.setInputNormals (model_normals);
  descr_est.setSearchSurface(model);

  //std::cout << "Pase por\n" << std::endl;//descr_est.setSearchSurface (model);
  descr_est.compute (*model_descriptors);
 
  std::cout << "compute() del Descriptor para el modelo realizado.\n" << std::endl;

  pcl::UniqueShapeContext<PointType, DescriptorType, RFType>  descr_est2;
  descr_est2.setRadiusSearch (descr_rad_);
  descr_est2.setMinimalRadius(descr_rad_/10);
  descr_est2.setLocalRadius(descr_rad_);
  descr_est2.setPointDensityRadius(descr_rad_/5);
