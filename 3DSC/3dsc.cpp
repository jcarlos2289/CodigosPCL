...
int main (int argc, char *argv[])
{
  ...
  pcl::ShapeContext3DEstimation<PointType, NormalType, DescriptorType>  descr_est2;
  ...
  descr_est2.setMinimalRadius(descr_rad_/5);
  descr_est2.setPointDensityRadius(descr_rad_/2);
